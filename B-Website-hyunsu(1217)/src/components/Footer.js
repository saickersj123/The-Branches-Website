        ...
        <div className="row">
          ...
          <section className="col-4 col-12-mobile">
            ...
            <div className="row gtr-25">
              <div className="col-6">
                <a href="#" className="image fit"><img src="assets/images/pic10.jpg" alt="" /></a>
              </div>
              <div className="col-6">
                <a href="#" className="image fit"><img src="assets/images/pic11.jpg" alt="" /></a>
              </div>
              <div className="col-6">
                <a href="#" className="image fit"><img src="assets/images/pic12.jpg" alt="" /></a>
              </div>
              <div className="col-6">
                <a href="#" className="image fit"><img src="assets/images/pic13.jpg" alt="" /></a>
              </div>
              <div className="col-6">
                <a href="#" className="image fit"><img src="assets/images/pic14.jpg" alt="" /></a>
              </div>
              <div className="col-6">
                <a href="#" className="image fit"><img src="assets/images/pic15.jpg" alt="" /></a>
              </div>
            </div>
          </section>
        </div>
