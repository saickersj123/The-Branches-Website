      ...
      <section id="meeting-place" className="container">
        ...
        <div className="meeting-place-info">
          <div className="meeting-place-image">
            <img src="/assets/images/모임장소1.jpg" alt="Meeting Place 1" />
            <img src="/assets/images/순천대.jpg" alt="Suncheon National University" />
          </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <section className="contact">
              ...
              <ul className="icons">
                <li>
                  <a href="https://www.scnu.ac.kr/" target="_blank" rel="noreferrer" className="icon solid fa-university">
                    <span className="label">University Website</span>
                  </a>
                </li>
                <li>
                  <a href="https://discord.gg/QMg4Dr9W" target="_blank" rel="noreferrer" className="icon brands fa-discord">
                    <span className="label">Discord</span>
                  </a>
                </li>
                <li>
                  <a href="https://www.notion.so/ko-kr" target="_blank" rel="noreferrer" className="icon solid fa-file-alt">
                    <span className="label">Notion</span>
                  </a>
                </li>
                <li>
                  <a href="https://github.com/" target="_blank" rel="noreferrer" className="icon brands fa-github">
