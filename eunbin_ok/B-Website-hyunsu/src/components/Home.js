      ...
      <section className="contact-section">
        ...
        <div className="contact-cards">
          <div className="contact-card">
            ...
            <button className="contact-button" onClick={() => window.open('https://www.scnu.ac.kr', '_blank')}>순천대학교로 이동하기</button>
          </div>
          <div className="contact-card">
            <h3>디스코드</h3>
            <p>Discord.com</p>
            <img src="/assets/images/discord.jpg" alt="디스코드 이미지" className="card-image" />
            <button className="contact-button" onClick={() => window.open('https://discord.com', '_blank')}>디스코드로 문의하기</button>
          </div>
          <div className="contact-card">
            <h3>노션</h3>
            <p>Notion.com</p>
            <img src="/assets/images/notion.jpg" alt="노션 이미지" className="card-image" />
            <button className="contact-button" onClick={() => window.open('https://www.notion.so', '_blank')}>notion으로 이동하기</button>
          </div>
          <div className="contact-card">
            <h3>깃허브</h3>
            <p>Github.com</p>
            <img src="/assets/images/github.jpg" alt="깃허브 이미지" className="card-image" />
            <button className="contact-button" onClick={() => window.open('https://github.com', '_blank')}>Git hub 구경하기</button>
          </div>
        </div>
      </section>
      <Footer />
